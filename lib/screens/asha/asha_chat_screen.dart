...
class ASHAChatScreen extends StatefulWidget {
  final String? userId;
  final String? userName;
  final String? userImageUrl;

  const ASHAChatScreen({
    super.key,
    this.userId,
    this.userName,
    this.userImageUrl,
  ...
  @override
  State<ASHAChatScreen> createState() => _ASHAChatScreenState();
}

class _ASHAChatScreenState extends State<ASHAChatScreen> {
      ...
      if (widget.userId != null && widget.userName != null) {
        try {
          final conversationId = await chatProvider.createConversation(
            widget.userId!,
            widget.userName!,
            ashaImageUrl: widget.userImageUrl,
          );
